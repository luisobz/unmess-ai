...
const I18N = (() => {
  const translations = {
    es: {
      ...
      settings_saved_restart: "Ajustes guardados. Reinicia el daemon para aplicar los cambios.",
      // Acerca de
    ...
    en: {
      ...
      settings_saved_restart: "Settings saved. Restart the daemon to apply the changes.",
